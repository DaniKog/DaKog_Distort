...
DaKog_RotorSlider::DaKog_RotorSlider ()
{
    ...
    m_LeftLabel->setFont (juce::Font (15.00f, juce::Font::plain).withTypefaceStyle ("Regular"));
    ...
    m_RightLabel->setFont (juce::Font (15.00f, juce::Font::plain).withTypefaceStyle ("Regular"));
